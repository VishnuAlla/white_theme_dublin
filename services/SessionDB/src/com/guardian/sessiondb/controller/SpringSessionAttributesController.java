...
import com.guardian.sessiondb.service.SpringSessionAttributesService;
...
public class SpringSessionAttributesController {
    ...
    @Autowired
	@Qualifier("SessionDB.SpringSessionAttributesService")
	...
	public SpringSessionAttributes createSpringSessionAttributes(@RequestBody SpringSessionAttributes springSessionAttributes) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SpringSessionAttributes getSpringSessionAttributes(@RequestParam("sessionId") String sessionId,@RequestParam("attributeName") String attributeName) throws EntityNotFoundException {

        SpringSessionAttributesId springsessionattributesId = new SpringSessionAttributesId();
        springsessionattributesId.setSessionId(sessionId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SpringSessionAttributes editSpringSessionAttributes(@RequestParam("sessionId") String sessionId,@RequestParam("attributeName") String attributeName, @RequestBody SpringSessionAttributes springSessionAttributes) throws EntityNotFoundException {

        springSessionAttributes.setSessionId(sessionId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSpringSessionAttributes(@RequestParam("sessionId") String sessionId,@RequestParam("attributeName") String attributeName) throws EntityNotFoundException {
    ...
    public Page<SpringSessionAttributes> searchSpringSessionAttributesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering SpringSessionAttributes list");
	...
	@ApiOperation(value = "Returns the total count of SpringSessionAttributes instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
